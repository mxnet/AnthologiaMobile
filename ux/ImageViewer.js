...
Ext.define('Ext.ux.ImageViewer', {
    ...
    onImageLoad : function() {
        ...
        if (me.getResizeOnLoad()) {
            ...
            me.innerMaxScale = me.scale * me.getMaxScale();
        } else {
    ...
    onImagePinch: function(ev) {
        ...
        me.scale = Ext.Number.constrain(ev.scale * me.startScale, me.baseScale - 2, me.innerMaxScale);
        me.applyTransform();
    },
    ...
    zoomIn: function() {
        ...
        if (myScale < me.innerMaxScale) {
            myScale = me.scale + 0.2;
        }
        
        if (myScale >= me.innerMaxScale) {
            myScale = me.innerMaxScale;
        }
    ...
    onDoubleTap: function(ev, t) {
        ...
        if (me.scale > me.baseScale) {
            ...
            // zoom in toward tap position
            var oldScale = me.scale,
                newScale = me.baseScale * me.getDoubleTapMaxScale(),
